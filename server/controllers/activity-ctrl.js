...
module.exports = {
    getActivities: async (req, res) => {
        try {
            const data = await activities.find().populate("comments").populate("q_a").populate("rating");
    ...
    getActivityById: async (req, res) => {
        try {
            const activity = await activities.findOne({ _id: req.params.id }).populate("comments").populate("q_a").populate("rating");
